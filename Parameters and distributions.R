...
Frac.HS.hamper <-runif(iterations, min=0.016, max=0.25)
Frac.HS.wash <-runif(iterations,min=0.13, max=0.25)
Frac.HS.fold<-runif(iterations, min=0.16, max=0.25)
Frac.HF <-runif(iterations, min=0.008, max=0.012) 

#Duration (min) / Contact time 
Dur.wash <- 50
Dur.lag <- runif(iterations,min=0, max=60)
Dur.dry <- 60
...
Surface.area.tshirt <-runif(iterations, min=4.9*10^3, max=1.2*10^4)
Surface.area.pants <-runif(iterations, min=9.7*10^3, max=1.8*10^4)
Size.household <- 2.53
Item.laundry<-2
Surface.area.laundry<-(Surface.area.tshirt+Surface.area.pants)*Size.household*Item.laundry


if(organism == "SARS-CoV-2") {  #--> I have a several errors operating this if else sentence. 
  #Transfer efficiency
  ...
  Inact.s <-rtriangle(1000, a=0.0001*0.75, b=0.0001*1.25, c=0.0001)
  ...
  Volume.cough<-4.77*10^(-5)
  Conversion.ratio<-runif(iterations, min=100, max=1000)
  
  Conc.onecloth<-(Viralload*Volume.cough*Freq.cough.day)/(Conversion.ratio*Surface.area.tshirt)
  Conc.laundry.1day<-Conc.onecloth/(Item.laundry*Size.household)
  Conc.i.laundry<-(Conc.laundry.1day*exp(-Inact.s*6*24*60)+Conc.laundry.1day*exp(-Inact.s*5*24*60)+ Conc.laundry.1day*exp(-Inact.s*4*24*60)+Conc.laundry.1day*exp(-Inact.s*3*24*60)+Conc.laundry.1day*exp(-Inact.s*2*24*60)+Conc.laundry.1day*exp(-Inact.s*1*24*60)+Conc.laundry.1day)
  ...
  Inact.h <-rtrunc(iterations, "norm", mean=7.5e-5*60, sd=4.3e-6*60, a=0, b=1)
  Inact.s <-runif(iterations, min=0.0025, max=0.0042)
  

  #Initial concentration on laundry on Sunday
  Viralload <-runif(iterations,min=10^10, max=10^12)
  mass.feces <-runif(iterations, min=0.01, max=1)
  Conc.onecloth<-Viralload*mass.feces/Surface.area.tshirt
  Conc.laundry.1day<-Conc.onecloth/(Item.laundry*Size.household)
  conc.i.laundry<-(Conc.laundry.1day*exp(-Inact.s*6*24*60)+Conc.laundry.1day*exp(-Inact.s*5*24*60)+
                     Conc.laundry.1day*exp(-Inact.s*4*24*60)+Conc.laundry.1day*exp(-Inact.s*3*24*60)+
                     Conc.laundry.1day*exp(-Inact.s*2*24*60)+Conc.laundry.1day*exp(-Inact.s*1*24*60)+
                     Conc.laundry.1day)
  #Dose response value 
  alpha<-2.53E-02
  N50<-6.17E+00
  ...
  #Reduction, inactivation
  Reduc.wash <-rtrunc(iterations,"norm", mean=3.4, sd=0.39, a=0, b=6.0)
  ...
  #Initial concentration on laundry on Sunday
  Viralload <-runif(iterations,min=10^6, max=10^10)
  mass.feces <-runif(iterations, min=0.01, max=1)
  Conc.onecloth<-Viralload*mass.feces/Surface.area.tshirt
  Conc.laundry.1day<-Conc.onecloth/(Item.laundry*Size.household)
  conc.i.laundry<-(Conc.laundry.1day*exp(-Inact.s*6*24*60)+Conc.laundry.1day*exp(-Inact.s*5*24*60)+
  ...
  Reduc.dry <-rtrunc(iterations, "norm", mean=6.1, sd=0.01, a=0, b=8.0)
  ...
  #Reduction, inactivation (cold, cotton)
  Reduc.wash <-rtrunc(iterations,"norm", mean=3.5, sd=0.96, a=0, b=5.0)
  Reduc.dry <-rtrunc(iterations, "norm", mean=8.0, sd=0.93, a=0, b=10.0)
  Reduc.hwash<-runif(iterations, min=0.91, max=3.78)
  Inact.h <-runif(iterations, min=0.05, max=0.0753)
  Inact.s <-runif(iterations, min=0.0015, max=0.0023)
  
  #Reduction various options 
  Reduc.dry.line<-rtrunc(iterations, "norm", mean=5.2, sd=0.55, a=0, b=7.0)
  Reduc.wash.terry <-rtruc(iterations, "norm", mean=2.1, sd=0.21, a=0, b=4)
  Reduc.wash.terry.warm<- rtruc(iterations, "norm", mean=2.1, sd=0.11, a=0, b=4.0)
