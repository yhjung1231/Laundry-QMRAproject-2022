...
if(organism == "SARS-CoV-2") {  
  ...
  Reduc.hwash<-runif(iterations, min=3, max=5.0)
...
} else if (organism == "Rotavirus") 
{
  ...
  Reduc.hwash<-runif(iterations, min=3, max=4.32)
  ...
  Reduc.hwash<-runif(iterations, min=3, max=3.78)
  ...
  Reduc.hwash<-runif(iterations, min=3, max=5.8)
